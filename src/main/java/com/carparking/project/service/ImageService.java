...
public class ImageService {
    ...
    public  void getImage(){
        ...
        SerialPort port = SerialPort.getCommPort("COM5"); // Example port name
        ...
        try (FileOutputStream fileOutput = new FileOutputStream("C:\\Users\\gokul\\Desktop\\test_image\\image.raw")) {
